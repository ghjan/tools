...
package main // import "github.com/golang/tools/cmd/callgraph"
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/golang/tools/cmd/callgraph |
      digraph succs github.com/golang/tools/cmd/callgraph.main
`
