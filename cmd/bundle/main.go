...
//
// Bundle github.com/golang/net/http2 for inclusion in net/http,
// prefixing all identifiers by "http2" instead of "http2_",
// and rewriting the import "github.com/golang/net/http2/hpack"
// to "internal/github.com/golang/net/http2/hpack":
//
//	cd $GOROOT/src/net/http
//	bundle -o h2_bundle.go \
//		-prefix http2 \
//		-import github.com/golang/net/http2/hpack=internal/github.com/golang/net/http2/hpack \
...
func bundle(src, dst, dstpkg, prefix string) ([]byte, error) {
	...
	fmt.Fprintf(&out, "// Code generated by github.com/golang/tools/cmd/bundle. DO NOT EDIT.\n")
	if *outputFile != "" {
